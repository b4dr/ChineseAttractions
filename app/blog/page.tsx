...
const featuredArticles = [
  ...
  },
  {
    ...
    author: 'Li Ming',
    authorTitle: 'Cultural Travel Expert',
    date: '2025-01-20',
    readTime: '18 min read',
    category: 'Seasonal Guides',
    slug: '/blog/chinese-new-year-2025-travel-guide',
    tags: ['Chinese New Year', 'Spring Festival', 'Traditions', 'Year of Snake'],
    featured: true,
    views: '2.5K',
    rating: 5.0,
    bookingLink: true,
  ...
  },
  {
    ...
    category: 'Essential Guides',
    slug: '/blog/china-visa-requirements-2025',
    tags: ['China Visa', 'Travel Requirements', 'Application Guide', '2025'],
    featured: true,
    views: '8.5K',
    rating: 4.9,
    bookingLink: true,
...
const travelGuides = [
  ...
  },
  {
    ...
    excerpt: 'China runs on QR codes, not cards. Set up Alipay and WeChat Pay with your foreign card before you land — the complete tourist payment guide.',
    image: '/images/blog/china-payment-apps.jpg',
    author: 'China Travel Team',
    authorTitle: 'China Travel Specialists',
    date: '2026-09-22',
    readTime: '12 min read',
    category: 'Essential Guides',
    slug: '/blog/china-payment-apps-guide-2026',
    tags: ['Alipay', 'WeChat Pay', 'Money', 'Essential'],
    views: '3.2K',
    rating: 4.9,
    practical: true
  },
  {
    ...
    excerpt: 'Google, WhatsApp, and Instagram are blocked. Best eSIMs with built-in VPN and exactly what to set up before flying to China.',
    image: '/images/blog/china-esim-vpn.jpg',
    author: 'China Travel Team',
    authorTitle: 'China Travel Specialists',
    date: '2026-09-22',
    readTime: '11 min read',
    category: 'Essential Guides',
    slug: '/blog/china-esim-vpn-guide-2026',
    tags: ['eSIM', 'VPN', 'Internet', 'Great Firewall'],
    views: '2.8K',
    rating: 4.8,
    practical: true
  },
  {
    ...
    excerpt: '45,000 km of bullet trains at 350 km/h. How to book tickets as a foreigner, choose seat classes, and navigate stations like a local.',
    image: '/images/blog/china-rail.jpg',
    author: 'China Travel Team',
    authorTitle: 'China Travel Specialists',
    date: '2026-09-22',
    readTime: '13 min read',
    category: 'Travel Planning',
    slug: '/blog/china-high-speed-rail-guide-2026',
    tags: ['Trains', 'Booking', 'Transport', '12306'],
    views: '2.1K',
    rating: 4.9,
    practical: true
  },
  {
    ...
    excerpt: 'The classic route optimized day by day: Beijing, Xi\'an, Chengdu, Guilin, and Shanghai with train routes and booking tips.',
    image: '/images/blog/china-itinerary.jpg',
    author: 'China Travel Team',
    authorTitle: 'China Travel Specialists',
    date: '2026-09-22',
    readTime: '14 min read',
    category: 'Travel Planning',
    slug: '/blog/china-itinerary-2-weeks-2026',
    tags: ['Itinerary', 'Planning', 'Golden Triangle', '2 Weeks'],
    views: '4.5K',
    rating: 5.0,
    featured: true,
    practical: true
  },
  {
    ...
    excerpt: 'What a China trip actually costs per day at every budget level — real prices for hotels, food, trains, and attractions.',
    image: '/images/blog/china-cost.jpg',
    author: 'China Travel Team',
    authorTitle: 'China Travel Specialists',
    date: '2026-09-22',
    readTime: '11 min read',
    category: 'Travel Planning',
    slug: '/blog/china-travel-cost-2026',
    tags: ['Budget', 'Costs', 'Planning', 'Money'],
    views: '1.9K',
    rating: 4.7,
    practical: true
  },
  {
    ...
    excerpt: 'The honest safety guide: real risks, the 5 scams that target tourists, health tips, and emergency numbers to save.',
    image: '/images/blog/china-safety.jpg',
    author: 'China Travel Team',
    authorTitle: 'China Travel Specialists',
    date: '2026-09-22',
    readTime: '12 min read',
    category: 'Essential Guides',
    slug: '/blog/china-safety-tips-2026',
    tags: ['Safety', 'Scams', 'Health', 'Emergency'],
    views: '2.4K',
    rating: 4.8,
    practical: true
  },
