          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-700 leading-relaxed">
              <p className="text-xl mb-6">
                Beijing, China's magnificent capital and the political heart of the world's most populous nation, stands as one of Earth's most extraordinary destinations. This ancient metropolis seamlessly weaves together over 3,000 years of imperial Chinese history with breathtaking modern innovation, creating an unparalleled travel experience. Home to some of humanity's greatest architectural marvels, including the legendary <strong><Link href="/attractions/great-wall-china" className="text-primary-600 font-semibold hover:underline">Great Wall of China</Link></strong>, the awe-inspiring <strong><Link href="/attractions/forbidden-city" className="text-primary-600 font-semibold hover:underline">Forbidden City</Link></strong>, and the sacred <strong><Link href="/attractions/temple-of-heaven" className="text-primary-600 font-semibold hover:underline">Temple of Heaven</Link></strong>, Beijing offers visitors an incomparable journey through the very soul of Chinese civilization.
              </p>
