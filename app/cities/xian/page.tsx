          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg mx-auto text-gray-700 leading-relaxed">
              <p className="text-xl mb-6">
                Xi'an, the ancient capital of China and one of the world's most historically significant cities, stands as a living testament to over 3,000 years of Chinese civilization. This extraordinary city served as the capital for 13 dynasties, including the powerful Tang Dynasty, making it one of the most important political, economic, and cultural centers in ancient China. Home to the world-renowned <strong><Link href="/attractions/terracotta-army" className="text-primary-600 font-semibold hover:underline">Terracotta Army</Link></strong>, the magnificent <strong>Ancient City Wall</strong>, and the starting point of the legendary <strong>Silk Road</strong>, Xi'an offers visitors an unparalleled journey through China's golden age of imperial grandeur and cultural achievement.
              </p>
